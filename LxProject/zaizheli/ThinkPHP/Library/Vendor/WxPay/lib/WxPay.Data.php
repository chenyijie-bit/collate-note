 ...
 * 企业付款数据对象
 */
class WxPayBzPay extends WxPayDataBase
{
  /**
   * 设置微信分配的公众账号ID
   * @param string $value
  ...
  public function SetPartenerTradeNo($value){
    $this->values['partner_trade_no'] = $value;
  }

  public function GetPartenerTradeNo(){
    return $this->values['partner_trade_no'];
  }

  public function IsPartenerTradeNo(){
  ...
  public function IsSpbilCreateIp(){
    return array_key_exists('spbill_create_ip', $this->values);
  }
